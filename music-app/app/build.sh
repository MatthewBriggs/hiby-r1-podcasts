...
zig cc -target mipsel-linux-gnueabihf.2.22 \
  ...
  -DSQLITE_THREADSAFE=0 -DSQLITE_DEFAULT_MEMSTATUS=0 -DSQLITE_OMIT_LOAD_EXTENSION=1 -DSQLITE_OMIT_DEPRECATED=1 -DSQLITE_TEMP_STORE=2 \
  -o libmusic_hook.so music_hook.c library.c audiobook.c audio.c wsola.c eq.c eqprofile.c mseb.c recent.c cover.c art.c status.c radio.c playlist.c tags.c aac.c alac.c mp4.c ts.c hls.c ogg_io.c vorbis_dec.c opus_dec.c vendor/ogg/framing.c vendor/dr_impl.c text.c vendor/sqlite3.c -lpthread -lm -ldl
